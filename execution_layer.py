from engine_types import ExecutionDecision
...
def production_decision(prediction,prices,min_edge_pp=3.0):
    ...
    return ExecutionDecision(prediction.model_version,side if eligible else None,edge,eligible,half_kelly(prob,odds) if eligible else 0.0,"Only production model controls wagering.")
